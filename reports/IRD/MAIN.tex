...
\newcommand{\titletwo}{\textsf{IRD}}
\newcommand{\titlethree}{\textsf{Software Interface Requirements Document}}
...
\newcounter{paranum}
\newcommand{\RQ}{\vspace{10pt}\noindent\textbf{FAQAS-IRD-REQ-\refstepcounter{paranum}\ifnum\value{paranum}<10 00\else 0\fi\theparanum}\textbf}
...
\newcommand{\DOCUMENTID}{ITT-1-9873-ESA-FAQAS-ISR}

...
%\clearpage
%
%\section{Toolset Evaluation by GomSpace}
%
%\includepdf[pages=-,scale=0.9,offset=0mm -75]{contributions/GomSpace Evaluation of MASS toolset Signed}
%\includepdf[pages=-,scale=0.9,offset=0mm -75]{contributions/GomSpace Evaluation of DAMAt Signed}
%
%\section{Toolset Evaluation by LuxSpace}   
%
%
%\includepdf[pages=-,scale=0.9,offset=0mm -75]{contributions/FAQ-LXS-TN-0001_1A MASS_DAMAt_SEMuS_Toolsets_LXS_Assessment}

...
In the following Table we provide a list of deliverable items released with this document. Each Item is identified by its path on the Alfresco system. \CHANGEDNOV{The location refers to the folder for the July review meeting.}

...
In the following Table we provide a list of deliverable items released \CHANGEDNOV{on July 2020} with this document. Each Item is identified by its path on the Alfresco system.

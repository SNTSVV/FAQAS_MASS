...
\INDEX{SEMu}~\cite{chekam2021killing} is a mutant analysis  framework based on dynamic symbolic execution that has been built on top of the KLEE Symbolic Virtual Machine~\cite{cadar2008klee}.
...
the test generation tool developed in FAQAS (i.e., \INDEX{SEMuS}, see Section~\ref{sec:semus}).
...
% \TODO{Check if correct what I wrote below}
...
%\DONE{You need to specify what is a 'kill formula'; in the folowing sentence or in previous paragraph, as appropriate. OSCAR: I provided a brief definition 3-4 paragraphs above.}

...
Listing~\ref{GSLaugmentationTwo} shows the main \index{limitations of CBMC}, indeed, although it includes a few definitions for standard library functions, some of them are generalizations and the original source code of the implementation may need to be provided in order to obtain correct results.

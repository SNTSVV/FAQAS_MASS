...
The system test suite consists of a total of {384} test cases, which take 10 hours to execute.
...
We randomly select {20} mutants for each bucket and inspect them with the help of engineers to determine if they are equivalent. 
...
In total, we manually inspect {200} mutants (20 mutants x 5 buckets x 2 configurations).
...
\subsubsection{RQ7 - \APPR Mutation Score}
...
\subsubsection{RQ8 - Threshold for the mutation score}

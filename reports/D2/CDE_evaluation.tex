...
\subsubsection{RQ9 - Threshold for the mutation score}
...
\REVNOV{PTCR-7}{Despite such experiment would be of great value, the required information is not currently available and thus it is not possible at this stag of the project to commit for addressing this research question.}

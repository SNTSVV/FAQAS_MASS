...
% \centering
% \tiny
% \caption{RQ6. MS Comparison with respect to Baseline approach.}
% \label{table:results:msReducedBaselinePVals} 
% \begin{tabular}{|llll|}
% \hline
% \textbf{Case Study}                & \textbf{\begin{tabular}[c]{@{}l@{}}MS Comparison\\w.r.t. Baseline\end{tabular}} & \textbf{ALL P-value} & \textbf{SDL P-value} \\
% \hline

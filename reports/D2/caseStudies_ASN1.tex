...
\DONE{You should provide an objective for mutation testing. What ind of problems do we aim to detect? I'm not sure if the analysis we propose he makes any sense.}

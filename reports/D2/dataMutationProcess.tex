...
In FAQAS, the data model and the fault model are coupled into a same structured representation, which is presented in Section~\ref{}.
...
\subsection{Data Model and Fault Model} % (fold)

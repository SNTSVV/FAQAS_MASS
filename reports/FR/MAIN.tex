...
% %%%% Title
% \newcommand{\titleone}{\textsf{Applicability of Mutation Testing Method for Flight Software (FAQAS)}}
% \newcommand{\titletwo}{\textsf{FR}}
% \newcommand{\titlethree}{\textsf{Final Report}}

%%%% NEW TEMPLATE %%%%
\newcommand{\DOCUMENTID}{ITT-1-9873-ESA-FAQAS-ESR}
\newcommand{\titleone}{Applicability of Mutation Testing to Flight Software}
\newcommand{\titletwo}{\textsf{(FR)}}
\newcommand{\titlethree}{\textsf{Final Report} (FR)}
%%%% NEW TEMPLATE END %%%%
...
\newcommand{\STARTCHANGEDNOV}{}
\newcommand{\ENDCHANGEDNOV}{}

\newcommand{\STARTCHANGEDFINAL}{\color{blue}}
\newcommand{\ENDCHANGEDFINAL}{\color{black}}


\newcommand{\STARTCHANGEDWPT}{}
\newcommand{\ENDCHANGEDWPT}{}
...
%The abstract should be a concise summary (limited to approximately 150 words) of the significant content of the report. It should reveal the salient features of the report concentrating on what was done and significant results. The opening sentence should inform the reader of the purpose and scope of the contract.

\include{FR_introduction}

%\include{acronyms}

\include{FR_background}
\input{FR_DAMAT_related.tex}
\input{FR_testgeneration.tex}
\input{FR_testgenerationData}
\input{FR_toolsetsEvaluationDataDriven}


\include{FR_approach}

\include{FR_caseStudies}

\include{FR_evaluation}
\input{FR_EvaluationRemarks}


\include{FR_Methodology}

\include{FR_ecss}

\STARTCHANGEDFINAL
\include{FR_toolsetDescription}
\ENDCHANGEDFINAL

\STARTCHANGEDFINAL
\include{FR_deliverables_sum}
\ENDCHANGEDFINAL

\include{FR_Limitations}

\include{FR_ScientificOutput}



\include{FR_Conclusion}

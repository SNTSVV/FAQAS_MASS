...
\begin{itemize}
  ...
  \item \textbf{Action taken:} SnT had not been able to replicate the problems; further investigation will be taken care of during the maintenance period. However, we recommend use SEMuS only in UNIX systems.

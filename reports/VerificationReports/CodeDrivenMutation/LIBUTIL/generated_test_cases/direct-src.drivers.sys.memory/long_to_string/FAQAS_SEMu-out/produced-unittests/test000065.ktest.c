...
/* The following mutants (IDs) were targeted to generated this test: [12] */
...
int main(int argc, char** argv)
{
    ...
    const unsigned char buf_size_faqas_semu_test_data[] = {0x07, 0x95, 0xa9, 0xee, 0x4a, 0xaa, 0xfb, 0xff};
    const unsigned char lvalue_faqas_semu_test_data[] = {0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    memcpy(&buf_size, buf_size_faqas_semu_test_data, sizeof(buf_size)); // Unsigned val is 18445523937634391303
    memcpy(&lvalue, lvalue_faqas_semu_test_data, sizeof(lvalue)); // Integer val is 40

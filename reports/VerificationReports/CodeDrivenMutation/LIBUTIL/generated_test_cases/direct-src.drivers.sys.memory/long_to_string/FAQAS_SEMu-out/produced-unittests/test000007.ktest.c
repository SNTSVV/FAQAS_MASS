...
int main(int argc, char** argv)
{
    ...
    const unsigned char lvalue_faqas_semu_test_data[] = {0x00, 0x00, 0x20, 0xe0, 0x00, 0x00, 0x00, 0x00};
    memcpy(&buf_size, buf_size_faqas_semu_test_data, sizeof(buf_size)); // Unsigned val is 18446649836735927552
    memcpy(&lvalue, lvalue_faqas_semu_test_data, sizeof(lvalue)); // Integer val is 3760193536

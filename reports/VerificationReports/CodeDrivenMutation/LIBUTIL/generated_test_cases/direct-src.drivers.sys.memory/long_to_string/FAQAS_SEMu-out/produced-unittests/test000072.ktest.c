...
int main(int argc, char** argv)
{
    ...
    const unsigned char buf_size_faqas_semu_test_data[] = {0x7f, 0x94, 0xa9, 0xbe, 0x4a, 0xaa, 0xff, 0xff};
    const unsigned char lvalue_faqas_semu_test_data[] = {0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    memcpy(&buf_size, buf_size_faqas_semu_test_data, sizeof(buf_size)); // Unsigned val is 18446649836735927423

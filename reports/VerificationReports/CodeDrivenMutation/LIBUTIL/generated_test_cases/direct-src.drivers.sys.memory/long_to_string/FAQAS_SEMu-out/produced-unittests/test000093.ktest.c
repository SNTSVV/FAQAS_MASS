...
/* The following mutants (IDs) were targeted to generated this test: [21] */
...
int main(int argc, char** argv)
{
    ...
    const unsigned char buf_size_faqas_semu_test_data[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    const unsigned char lvalue_faqas_semu_test_data[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0};
    memcpy(&buf_size, buf_size_faqas_semu_test_data, sizeof(buf_size)); // Unsigned val is 0
    memcpy(&lvalue, lvalue_faqas_semu_test_data, sizeof(lvalue)); // Integer val is -4611686018427387904

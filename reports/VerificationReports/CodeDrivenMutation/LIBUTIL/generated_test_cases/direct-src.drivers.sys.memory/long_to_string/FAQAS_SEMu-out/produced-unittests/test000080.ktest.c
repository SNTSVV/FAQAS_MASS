...
/* The following mutants (IDs) were targeted to generated this test: [16] */
...
int main(int argc, char** argv)
{
    ...
    const unsigned char buf_size_faqas_semu_test_data[] = {0x02, 0x95, 0xa9, 0xbe, 0x4a, 0xaa, 0xff, 0x7f};
    const unsigned char lvalue_faqas_semu_test_data[] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f};
    memcpy(&buf_size, buf_size_faqas_semu_test_data, sizeof(buf_size)); // Unsigned val is 9223277799881151746
    memcpy(&lvalue, lvalue_faqas_semu_test_data, sizeof(lvalue)); // Integer val is 9223372036854775807

...
int main(int argc, char** argv)
{
    ...
    const unsigned char lvalue_faqas_semu_test_data[] = {0xff, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff};
    memcpy(&buf_size, buf_size_faqas_semu_test_data, sizeof(buf_size)); // Unsigned val is 0
    memcpy(&lvalue, lvalue_faqas_semu_test_data, sizeof(lvalue)); // Integer val is -4294967297

...
int main(int argc, char** argv)
{
    ...
    const unsigned char buf_size_faqas_semu_test_data[] = {0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    const unsigned char lvalue_faqas_semu_test_data[] = {0x28, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    memcpy(&buf_size, buf_size_faqas_semu_test_data, sizeof(buf_size)); // Unsigned val is 1

...
\newstaticframe{0.4\textwidth}{40cm}{2pt}{0pt}[head]

\newstaticframe{0.4\textwidth}{37cm}{2pt}{0pt}[title]
...
\setstaticcontents*{title}{\Huge\slshape\MakeUppercase{Testing mission-readiness of test suites}}

\setstaticcontents*{img}{\includegraphics[width=14cm]{FAQAS-overview.pdf}}

\setstaticcontents*{logo}{University of Luxembourg. SnT Centre. Contact: Technology Transfer Office, snt-tto@uni.lu. \hspace{10cm} \includegraphics[width=2cm]{logo-uni-lu.pdf}\hspace{2mm}\includegraphics[width=2cm]{logo-snt.pdf} }

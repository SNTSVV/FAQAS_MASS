...
\newcommand{\titletwo}{\textsf{SRF}}
\newcommand{\titlethree}{\textsf{Software Reuse File}}
...
\newcommand{\DOCUMENTID}{ITT-1-9873-ESA-FAQAS-SRF}
...
\newcommand{\REVTOOL}[2]{\todo{\tiny{#1}}\color{red}{#2}\color{black}}

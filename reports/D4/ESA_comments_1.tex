...
\TODO{Oscar, in Table 2.26 add two rows: ESAIL\_System+Unit and ASN1CC. Also, delete the first two columns and keep only the MASS MS.}
\end{minipage}\\
\\
\hline
TDR-D4-PABG-2&
...
\TODO{Test cases execution time: didn't we generate a file with the time? The file you use for timeouts?}
\end{minipage}\\
\\
\hline
TDR-D4-PABG-6&

...
$\mathit{Libutil}$&14\,574&10\,376&4\,198&71.20 \\ %35
\hline
\end{tabular}
...
\REVFINAL{A9}{For \UTIL, SEMuS kills  35 additional mutants, increasing the mutation score from 71.20\% to 71.44\%. For \ESAIL, we simply demonstrated that SEMuS can generate test cases that kill mutants (the considered mutants were already killed by the SUT test suite).}

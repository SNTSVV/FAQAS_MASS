...
Table~\ref{table:faultModel:FAQAS} provides a preliminary list of data fault classes that will be supported by the FAQAS framework along with a description. For each fault class we indicate the data types to which it is expected to be applied, we identify \FIXME{seven} data types: 
\begin{itemize}
...
\item hex, which indicates data that should be treated as hexadecimal

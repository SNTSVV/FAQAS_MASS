...
The FAQAS framework will be applied to \MREVISION{C-P-40}{six} case study systems. Table~\ref{tab:caseStudies} provides the list of case studies along with an indication of the type of mutation analysis/testing (i.e., code-driven or data-driven) and the tools they will be targeted for. 
...
\hline
\textbf{Partner}&\textbf{Case study}&\multicolumn{2}{c}{\textbf{Code-driven}}&\multicolumn{2}{c}{\textbf{Data-driven}}\\

...
\REVISION{P-15d}{
\RQ{} The \FAQAS shall be configured through a text file.
...
\RQ{} \REVISION{SUTP-4}{The \FAQAS shall be tested as a whole, based on tutorial examples described in SUM. The system testing procedure is reported in the SVS - software validation specification.}

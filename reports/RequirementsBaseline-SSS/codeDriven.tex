...
\RQ{} The \FAQAS shall report a summary of the results obtained in every step of the mutation testing process. \REVISION{P-12}{The report shall report information about the total number of mutants generated, the total number of mutants filtered by compiler optimisations, type of sampling, total number of mutants executed, total number of killed mutants, total number of live mutants, mutation score, statement coverage, and the location of the two prioritized lists of nonequivalent mutants.}

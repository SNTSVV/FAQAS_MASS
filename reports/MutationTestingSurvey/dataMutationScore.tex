...
The $\NMOA$, (\INDEX{NMOA}) consequently, should capture the number of mutations that were performed. When following the approach of Di Nardo et al.~\cite{di2015generating}, NMOA corresponds to the number of model elements for which at least one instance had been mutated. 

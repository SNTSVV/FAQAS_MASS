...
Among the existing toolsets based on block-models, \INDEX{Peach} is the only one which supports the automated generation of test data. It's implementation simply generates random data, the process is referred to as 
...
\REVTWO{C37}{\subsection{Automated Generation of Test Oracles}}

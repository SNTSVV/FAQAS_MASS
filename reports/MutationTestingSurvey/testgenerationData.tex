...
When the data exchanged on the targeted communication layer coincide with the input data, existing approaches based on constraint-solvers can be adopted. 

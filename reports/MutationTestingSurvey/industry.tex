...
Concerning the adoption of industrial case studies, the most related case is that of \cite{delgado2018evaluation} where mutation testing has been applied to 15 functions of a Commercial Off The Shelf Component used in nuclear systems. However, the applicability of mutation testing on large scale satellite systems has not been empirically evaluated yet.

Other papers addressing the applicability of mutation testing to space and safety critical systems are that of Daran and Thévenod-Fosse~\cite{daran1996software}, who conducted a study to identify if mutations are correlated with real faults, the experimentation was carried out on a critical software from the civil nuclear field.

Andrews et al.~\cite{andrews2005mutation}, who explored the relation between hand-seeded and real faults in the Space software. Space is a software developed at the European Space Agency that it is been used for testing strategy evaluations since 1998 \cite{frankl1998further}.

Baker and Habli~\cite{baker2012empirical}, who conducted experimentation on two safety-critical airborne systems, C and Ada, that had satisfied the coverage requirements for certification. In their experiments, they found an effective subset of mutation operators able to detect multiple deficiencies in test suites already assessed by experts. 

...
Empirical studies on grammars has been performed since long ago, for instance Ghosh et al.~\cite{ghosh1998testing} carried on experimentation on a set of Windows NT utitlies such as \texttt{attrib, chkdsk, comp, expand, fc, find, help, label} and \texttt{replace}.

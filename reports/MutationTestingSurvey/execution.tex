...
\DONE{The following sentence needs to be clarified.}
...
\DONE{In the following, I cannot undestand what is in parenthesis}
Papadakis and Malevris \cite{papadakis2011automatically} rely on data-flow analysis to determine which mutants modify variables that reach the \INDEX{killing condition} of the mutant (i.e., program execution path that lead the mutant to be killed). These mutants are prioritized over mutants that do not modify variables reaching a killing condition.
...
\DONE{In the following, we miss an indication of how they measure if a mutant is close. Also, we do not say what performs better.}

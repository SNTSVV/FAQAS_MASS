...
Following the same criterion, we then selected the \INDEX{sufficient set of operators}, because most of the mutation tools already implement them, and because 

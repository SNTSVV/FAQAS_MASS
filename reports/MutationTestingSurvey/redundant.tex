...
\MREVISION{C15}{Identifying all the redundant mutants is equal to finding the minimal set of mutants. \textit{A minimal set of mutants has no redundancy, that is, every test set that kills these mutants will also kill all remaining mutants} \cite{kurtz2015static}. Similar to \INDEX{equivalent mutants}, finding the minimal set of mutants is an undecidable problem, and it can be only approximated.}

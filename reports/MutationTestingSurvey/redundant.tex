...
\oscar{Does compiler optimization go well with schemata? Should we introduce temporary variable to detect redundant mutants with schemata and optimization?}

...
\TODO{I cannot understand if the followng is redundant with the new section about sufficient set of operators. If not, please clarify that these studies target redundant mutants.}
...
The deletion operators defined by Delamaro et al.~\cite{delamaro2014designing} produce less redundant mutants.
...
\TODO{In the following, 'The approach introduces' does not make sense. Do you mean 'The work assigns a degree of redundancy to every..', which indicate sthat is a degree taht can be reused across projects, or do you meam 'The approach analyzes the program to be mutated and computes a degree...'  ?}
The approach introduces a degree of redundancy for every mutation operator that helps developers to choose the mutation operators with a lower degree of redundancy, based on the test cases defined in the project.

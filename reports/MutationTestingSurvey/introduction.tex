...
\MREVISION{C10}{Despite the proposed solutions can be applied to different kinds of software for space systems (i.e., ground desktop software, ground embedded software, on-board embedded software), in this book, the term \emph{space software} is used to refer to on-board embedded software.}

...
SOLMI implements four operators that (1) introduce XML meta-charcaters, (2) introduce closing tags, (3) replicate XML elements, (4) replace XML content.
...
An additional source on the adoption of fuzzying and grammar-based approaches to perform test input generation is the \emph{Fuzzing Book}~\cite{fuzzingbook2019:GrammarFuzzer}.

...
\node[draw=none,fill=none,right] at (-2, -7){\color{white}\LARGE\bf\titleone};
\node[draw=none,fill=none,right] at (-2, -8){\color{white}\LARGE\bf\titletwo};
\node[draw=none,fill=none,right] at (-2, -9){\color{white}\LARGE\bf\titlethree};

\node[draw=none,fill=none,right] at (-2, -12){\color{white}\Large\textsf{F. Pastore, O. Cornejo}};
\node[draw=none,fill=none,right] at (-2, -13){\color{white}\Large\textsf{Interdisciplinary Centre for Security, Reliability and Trust}};
\node[draw=none,fill=none,right] at (-2, -14){\color{white}\Large\textsf{University of Luxembourg}};
\node[draw=none,fill=none,right] at (11, -16){\color{white}\textsf{ITT-1-9873-ESA-FAQAS-D1}};
\node[draw=none,fill=none,right] at (11, -17){\color{white}\Large\textsf{Issue 5, Rev. 0}};

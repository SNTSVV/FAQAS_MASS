...
\node[draw=none,fill=none,right] at (-2, -12){\color{white}\Large\textsf{Interdisciplinary Centre for Security, Reliability and Trust}};
\node[draw=none,fill=none,right] at (-2, -13){\color{white}\Large\textsf{University of Luxembourg}};

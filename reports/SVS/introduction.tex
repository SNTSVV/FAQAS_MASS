...
% \subsubsection{ESAIL}
%
% The variables for running the DAMAt-pipeline on ESAIL must be set in the \emph{DAMAt\_configure.sh} file, as reported in Listing~\ref{lst:configure_esail}. The significance of this variables is described in the SUM.
%
...
The compilation log shall report the diciture \texttt{compilation OK}.
...
The compilation output shall report the diciture \texttt{configuration OK}.
...
All test cases listed in Listing~\ref{lst:test_esail} shall pass.
...
All test cases listed in Listing~\ref{lst:test_param} shall pass.

\subsection{Configuring and running \emph{DAMAt\_obtain\_coverage.sh}}

\subsubsection{ESAIL}

The variables for running the DAMAt-pipeline on ESAIL must be set in the \emph{DAMAt\_configure.sh} file, as reported in Listing~\ref{lst:configure_esail}. The significance of this variables is described in the SUM (Chapter 13).
...
Every file shall contain a subset of the tests listed in Listing~\ref{lst:test_esail}.

\subsubsection{LibParam}

The variables for running the DAMAt-pipeline on ESAIL must be set in the \emph{DAMAt\_configure.sh} file, as reported in Listing~\ref{lst:configure_param}. The significance of this variables is described in the SUM (Chapter 13).
...
No test cases shall fail.
A \texttt{testlist} folder shall be generated. Inside this folder there shall be a file called \texttt{test\_<mutant>} for every mutant.
Every file shall contain a subset of the tests listed in Listing~\ref{lst:test_param}.
...
Then the commands represented in Listing~\ref{lst:launcher_esail_cmds} must be run.
  ...
  The compilation logs shall report the diciture \texttt{compilation OK}.
...
The compilation logs shall report the diciture \texttt{configuration OK}.
A \texttt{testlist} folder shall be generated. Inside this folder there shall be a file called \texttt{test\_<mutationID>} for every mutant containing a subset of the tests listed in Listing~\ref{lst:test_param}.
A \texttt{results} folder shall be generated and it shall contain the files described in the SUM (Section 9.2).

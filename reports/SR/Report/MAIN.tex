...
%%%% Title
%%%% NEW TEMPLATE %%%%
\newcommand{\DOCUMENTID}{ITT-1-9873-ESA-FAQAS-SR}
\newcommand{\titleone}{\textsf{Applicability of Mutation Testing to Flight Software}}
\newcommand{\titletwo}{\textsf{FAQAS}}
\newcommand{\titlethree}{\textsf{Summary Report} (SR)}
%%%% NEW TEMPLATE END %%%%
...
\newcommand{\MASS}{MASS\xspace{} }
\newcommand{\SEMUS}{SEMuS\xspace{} }
...
\clearpage
\section{MASS Approach - Published on IEEE Transactions on Software Engineering}
%\label{appendix:esailFM}
\includepdf[pages=-,scale=1,offset=0mm 0]{papers/TSE-MASS.pdf}

\section{DAMAt Approach - Submitted to ICSE'22}
\includepdf[pages=-,scale=1,offset=0mm 0]{papers/ICSE22-DAMAT.pdf}

\section{MASS Tool - Submitted to ICSE'22}
\includepdf[pages=-,scale=1,offset=0mm 0]{papers/ICSE22-MASS-TOOL.pdf}
%

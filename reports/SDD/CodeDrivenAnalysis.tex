...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item \textit{TestTimeouts}: csv file containing one line per test case. Each line includes the name  of the test case, followed by the test execution time threshold, in seconds. For example, the line \texttt{acos:6} indicates that the test case \texttt{acos} cannot be executed for more than six seconds.
	\end{itemize}

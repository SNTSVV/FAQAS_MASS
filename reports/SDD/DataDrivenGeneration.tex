...
The activity \emph{Execute KLEE} indicates that the end-user should execute KLEE, after performing the required scaffolding, if necessary. 
%A methodological procedure document to support the end-user will be provided.

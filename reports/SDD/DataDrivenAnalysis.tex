...
\begin{figure}[tb]
  \centering
	\includegraphics[width=0.9\textwidth]{images/damat_components.png}
      \caption{UML Component diagram of the data-driven mutation testing component to evaluate test suite effectiveness. Black arrows show outputs, red arrows show inputs.}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \textit{get\_stats} this component processes \textit{readable\_coverage.csv}, \textit{readable\_operator\_co\-verage.csv} and \textit{readable\_data.csv} to produce \textit{final\_mutants\_table.csv}

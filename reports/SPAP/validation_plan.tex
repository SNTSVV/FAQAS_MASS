...
\REVFINAL{A14}{A detailed description of the validation procedures applied to \MASS can be found in the SVS document and a practical example of this can be found on the SUM document on Chapter 11.}
...
\REVFINAL{A14}{A detailed description of the validation procedures applied to \SEMUS can be found in the SVS document and a practical example of this can be found on the SUM document on Chapter 12.}
...
\REVFINAL{A14}{A detailed description of the validation procedures applied to \DAMA can be found in the SVS document.}

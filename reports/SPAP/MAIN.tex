...
\newcommand{\REVFINAL}[2]{\todo{\tiny{#1}}\color{blue}{#2}\color{black}}


\newcommand{\EMPH}[1]{\textbf{\emph{#1}}}
\newcommand{\INDEX}[1]{\index{\MakeLowercase{#1}}\EMPH{#1}}

\newcommand{\DAMTE}{\textit{DAMTE}\xspace }
...
\newcommand{\DOCUMENTID}{ITT-1-9873-ESA-FAQAS-SPAP}
...
% \input{software_product_assurance}

% \input{software_process_assurance}
...
\clearpage
\input{development_plan} %done (apart from the work packages'tables)
\ENDCHANGEDFINAL
...
\clearpage
\input{product_assurance_plan}
\ENDCHANGEDFINAL

\appendix

\chapter{ECSS Tailoring}
\label{appendix:tailoring}
\section{Tailoring of ECSS-E-ST-40C}
\includepdf[pages=-,scale=0.9,offset=0mm -75]{contributions/TailoringECSS-E-ST-40C.pdf}
\clearpage
\section{Tailoring of ECSS-Q-ST-80C}
\includepdf[pages=-,scale=0.9,offset=0mm -75]{contributions/TailoringECSS-Q-ST-80C.pdf}

...
We validated the eight steps of \MASS on the LXS System Test Suite for ESAIL, the GSL Integration Test Suite for libgscsp, the GSL System Test Suite for libparam, the MLFS Unit Test Suite, the GSL Unit Test Suite for libutil, and the ASN.1 Auto-generated Unit Test Suite. We also verified that outputs complied with the system specifications. A full description of the validation of \MASS on the MLFS case study can be found on the SUM document on Chapter 11.
...
We validated the four steps of the methodology on the MLFS, the ASN.1, the Libutil, and the ESAIL case studies, we also verified that outputs are in line with system specifications. A detailed description of the validation of \SEMUS on the ASN.1 case study can be found on the SUM document on Chapter 12.

...
We validated the four steps of the methodology on the MLFS and the ASN.1 case studies, we also verified that outputs are in line with system specifications. A detailed description of the validation of \SEMUS on the ASN.1 case study can be found on the SUM document on Chapter 12.

...
Fabrizio Pastore, Oscar Cornejo, Enrico Viganò&
\begin{minipage}{8cm}
Addressed A6 (Section~\ref{sec:semus:config:hw}). Updated Chapter\ref{chapter:semus:tutorial}; added Chapters \ref{chapter:semus:tutorial:util} and \ref{chapter:semus:tutorial:esail}.
\end{minipage}
\\

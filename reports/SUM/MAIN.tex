...
\newcommand{\DOCUMENTID}{ITT-1-9873-ESA-FAQAS-SUM}
...
\newcommand{\STARTCHANGEDFR}{}
\newcommand{\ENDCHANGEDFR}{}

\newcommand{\STARTCHANGEDFRTWO}{\color{blue}}
\newcommand{\ENDCHANGEDFRTWO}{\color{black}}
...
\newcommand{\REVFR}[2]{\todo{\tiny{#1}}\color{blue}{#2}\color{black}}

%Example: \REVOCT{P-1}{yeydhd}
...
\STARTCHANGEDFR
\include{manual_semus}
\ENDCHANGEDFR

\include{manual_dama}

\STARTCHANGEDFR
\include{manual_damte}
\ENDCHANGEDFR
...
\include{tutorial}
\STARTCHANGEDFR
\include{tutorial_semus}
\include{tutorial_semus_libutil}
\include{tutorial_semus_esail}
\ENDCHANGEDFR
\include{tutorial_dama}

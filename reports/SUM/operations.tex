...
\REVOCT{P-1}{Execution with HPC is feasible, however, given that test generation is fast it can be achieved also with a laptop. Also, even in case of relying on an HPC, it is first necessary to generate test templates, which require manual intervention and thus is easier to be performed with a standard development environment.
}

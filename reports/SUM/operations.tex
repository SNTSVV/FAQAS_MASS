...
\MASS toolset uses a host computer with Linux operating system. \MASS needs the following hardware requirements to be executed on single machines:
...
\MASS toolset can be also executed on HPC infrastructures. These are the minimum hardware configurations to be set on HPCs for a single job:

...
The \emph{probe comments} are regular \emph{C}/\emph{C++} comments, so they do not influence the normal execution of the source code and can be kept in the code during every step of a CD/CI pipeline.
...
In those cases, the user shall write a \emph{probe template}.

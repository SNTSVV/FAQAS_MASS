...
\begin{enumerate}
	...
	\item Compile Optimized Mutants Post-Processing: the results of this step are stored in the folder \texttt{COMPILED}. Particularly, it generates four lists: (i) list of all mutants, (ii) list of nonequivalent and nonredundant mutants, (iii) list of equivalent mutants, and (iv) list of redundant mutants.

...
\begin{itemize}
	...
	\DONE{"has to be set" what does it mean?}
...
\begin{itemize}
	...
	\item The script shall contain a 'sort' command in the source list to be compiled, to ensure that source files are always compiled in the same order; \DONE{Not clear what a source dependency list is, example?}

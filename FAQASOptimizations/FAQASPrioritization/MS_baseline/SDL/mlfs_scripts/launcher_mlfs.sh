...
PRIORITIZATION=$FAQAS/MLFS/COVERAGE_TESTS_MATCH/sources
...
PROCESS=$FAQAS/srcirorfaqas/FAQASOptimizations/FAQASPrioritization/MS_baseline/mlfs_scripts/process_ms.py

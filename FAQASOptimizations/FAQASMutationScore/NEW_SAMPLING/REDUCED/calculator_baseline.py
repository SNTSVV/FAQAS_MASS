...
def get_prioritized_tests(prioritization_path, location, mutant_name, mutant_line, iteration):
    tests_list = []
...
def define_killed(file_path, prioritization_path, test_path, original_order, iteration):
    ...
    for key, value in traces.items():
        ...
        p_tests = get_prioritized_tests(prioritization_path, location, mutant_name, mutant_line, iteration)
        status = 0

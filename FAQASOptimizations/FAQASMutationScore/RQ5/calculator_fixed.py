...
def get_prioritized_tests(prioritization_path, strategy, location, mutant_name, mutant_line):
    tests_list = []

    relative_path = os.path.join(prioritization_path, strategy, location)
    try:
...
def calculate_mutation_score(file_path, prioritization_path, test_path, original_order, strategy, mutants_count, TOT, iteration):
    ...
    for key, value in traces.items():
        ...
        p_tests = get_prioritized_tests(prioritization_path, strategy, location, mutant_name, mutant_line)

...
class MASSSampling:
    ...
    def __init__(self, results_mutants_file, sampling, total_mutants, reduced):
        self.results_mutants_file = results_mutants_file
    ...
    def fsci_prt_stopping_criterion(self):
        ...
        # print("prt stopping criterion is", result)
        #print(result)
        return int(result)
    ...
    def estimate_error(self, error_mutants_file):
    ...
    def setFsciError(self, error_mutants_file):
        error_prt = self.estimate_error(error_mutants_file)

...
if [ $tst_a -eq 0 ];then
    echo -e "${GREEN}TEST lod_logic_or a PASSED$NC"
else
    echo -e "${RED}TEST lod_logic_or a FAILED$NC"
fi

if [ $tst_b -eq 0 ];then
    echo -e "${GREEN}TEST lod_logic_or b PASSED$NC"
else
    echo -e "${RED}TEST lod_logic_or b FAILED$NC"
fi

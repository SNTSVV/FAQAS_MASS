...
FAQAS_SEMU_GENERATED_META_MU_MAKE_SYM_SRC_FILE=$FAQAS_SEMU_GENERATED_MUTANTS_TOPDIR/test.MetaMu.MakeSym.c

FAQAS_SEMU_GENERATED_META_MU_MAKE_SYM_BC_FILE=$FAQAS_SEMU_GENERATED_MUTANTS_TOPDIR/test.MetaMu.MakeSym.bc

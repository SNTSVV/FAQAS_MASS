...
/* Wrapping main template for the function My2ndTypeNested_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = My2ndTypeNested_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

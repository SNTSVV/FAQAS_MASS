...
/* Wrapping main template for the function SubTypeWithOptional_Decode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = SubTypeWithOptional_Decode(&pVal, &pBitStrm, &pErrCode);

...
/* Wrapping main template for the function FixedLenConfigString_Decode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = FixedLenConfigString_Decode(val, &pBitStrm, &pErrCode);

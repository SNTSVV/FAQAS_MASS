...
/* Wrapping main template for the function T_TypeThatMustNotBeMappedExceptInPython_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = T_TypeThatMustNotBeMappedExceptInPython_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

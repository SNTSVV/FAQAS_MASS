...
/* Wrapping main template for the function My2ndAType_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    klee_make_symbolic(&pVal, sizeof(pVal), "pVal"); //AType
    ...
    result_faqas_semu = My2ndAType_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

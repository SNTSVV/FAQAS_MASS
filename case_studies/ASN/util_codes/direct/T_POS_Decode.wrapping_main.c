...
/* Wrapping main template for the function T_POS_Decode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = T_POS_Decode(&pVal, &pBitStrm, &pErrCode);

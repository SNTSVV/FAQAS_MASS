...
/* Wrapping main template for the function My2ndBool_Decode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = My2ndBool_Decode(&pVal, &pBitStrm, &pErrCode);

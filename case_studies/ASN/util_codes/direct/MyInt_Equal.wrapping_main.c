...
/* Wrapping main template for the function MyInt_Equal defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = MyInt_Equal(&pVal1, &pVal2);

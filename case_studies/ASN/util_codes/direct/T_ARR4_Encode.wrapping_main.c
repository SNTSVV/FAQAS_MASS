...
/* Wrapping main template for the function T_ARR4_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    klee_make_symbolic(&pVal, sizeof(pVal), "pVal"); //T_ARR4
    ...
    result_faqas_semu = T_ARR4_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

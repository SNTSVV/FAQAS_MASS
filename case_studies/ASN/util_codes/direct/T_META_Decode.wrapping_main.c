...
/* Wrapping main template for the function T_META_Decode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = T_META_Decode(&pVal, &pBitStrm, &pErrCode);

...
/* Wrapping main template for the function My2ndInt_Equal defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = My2ndInt_Equal(&pVal1, &pVal2);

...
/* Wrapping main template for the function E_Decode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = E_Decode(&pVal, &pBitStrm, &pErrCode);

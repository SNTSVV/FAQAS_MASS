...
/* Wrapping main template for the function TypeWithOptional_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = TypeWithOptional_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

...
int main(int argc, char** argv)
{
    ...
    klee_make_symbolic(&pVal1, sizeof(pVal1), "pVal1"); //AType_blArray
    klee_make_symbolic(&pVal2, sizeof(pVal2), "pVal2"); //AType_blArray

    // Call function under test
    result_faqas_semu = AType_blArray_Equal(&pVal1, &pVal2);

...
/* Wrapping main template for the function T_SET_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    klee_make_symbolic(&pVal, sizeof(pVal), "pVal"); //T_SET
    klee_make_symbolic(&bCheckConstraints, sizeof(bCheckConstraints), "bCheckConstraints"); //_Bool

    // Call function under test
    result_faqas_semu = T_SET_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

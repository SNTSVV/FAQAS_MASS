...
/* Wrapping main template for the function T_ARR2_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = T_ARR2_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

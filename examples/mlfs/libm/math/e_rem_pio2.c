 ...
 * 2017-06-21 | F. Schriever | Remove input variable prec from call to __kernel_rem_pio2
 * 2017-07-31 | F. Schriever | Move array two_over_pi to __kernel_rem_pio2
 * 2017-08-17 | F. Schriever | Remove no cancellation optimisation, according to https://github.com/freebsd/freebsd/commit/e31bf4b688423b9d648923a471ed8a41940b9432
 * 
...
#endif
{
	...
	n  =  __kernel_rem_pio2(tx,y,e0,nx);
	if(hx<0) {y[0] = -y[0]; y[1] = -y[1]; return -n;}
	return n;
}

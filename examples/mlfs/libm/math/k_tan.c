 ...
 *      4000117691/16/NL/FE
 * \brief Implementation file for kernel tan.
 ...
 * Date       | Name         | Change
 * -----------|--------------|-----------------------------------------------
 * 2017-06-06 | F. Schriever | Introduce accuracy improvement from fdlibm 5.3
...
#ifdef __STDC__
	double __kernel_tan(double x, double y, __int32_t iy)
#else
	double __kernel_tan(x, y, iy)
	double x,y; __int32_t iy;
#endif
{
	double z,r,v,w,s;
	__int32_t ix,hx;

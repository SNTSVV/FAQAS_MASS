 ...
 *      4000117691/16/NL/FE
 * \brief Implementation file for ieee754 powf function.
 ...
 * Date       | Name         | Change
 * -----------|--------------|-----------------------------------------------------------
 * 2017-07-31 | F. Schriever | Input (-1,NaN) caused +1 as result, changed to return NaN.
 * 2017-08-17 | F. Schriever | Fix signs for under- and overflows, according to https://github.com/freebsd/freebsd/commit/dbfd4ab6f2ca187676df23464479a62015543e54
 * 2017-08-17 | F. Schriever | Fix 2 bugs in the computation of t_h=ax+bp[k], according to https://github.com/freebsd/freebsd/commit/ad1b692494d1edda81bf02287d6e275160176f22
 * 2017-08-17 | F. Schriever | Fix bug in the computation of t=p_l+p_h, according to https://github.com/freebsd/freebsd/commit/719aa077cb43ef51a1a90748f36a8f0e11e155c6
 * 2017-08-17 | F. Schriever | Fix hi+lo composition of cp (2/(3ln(2))), according to https://github.com/freebsd/freebsd/commit/30aa45f24bdd40449d3297b08a7214d362264c2c
 * 2017-08-18 | F. Schriever | Make variables huge and tiny volatile to enforce correct behaviour with regards to exceptions (otherwise the calculation may no longer exist after compilation due to optimization).
 * 

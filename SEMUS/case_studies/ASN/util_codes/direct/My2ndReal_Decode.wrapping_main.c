...
/* Wrapping main template for the function My2ndReal_Decode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = My2ndReal_Decode(&pVal, &pBitStrm, &pErrCode);

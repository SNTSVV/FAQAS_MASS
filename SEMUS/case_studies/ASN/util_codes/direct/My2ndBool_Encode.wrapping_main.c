...
/* Wrapping main template for the function My2ndBool_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = My2ndBool_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

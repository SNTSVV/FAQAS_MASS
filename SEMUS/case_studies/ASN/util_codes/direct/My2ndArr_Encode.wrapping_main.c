...
/* Wrapping main template for the function My2ndArr_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    klee_make_symbolic(&pVal, sizeof(pVal), "pVal"); //T_ARR
    ...
    result_faqas_semu = My2ndArr_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

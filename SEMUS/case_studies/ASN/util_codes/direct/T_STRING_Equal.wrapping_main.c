...
/* Wrapping main template for the function T_STRING_Equal defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = T_STRING_Equal(&pVal1, &pVal2);

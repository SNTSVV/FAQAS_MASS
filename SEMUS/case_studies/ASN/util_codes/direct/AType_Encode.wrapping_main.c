...
/* Wrapping main template for the function AType_Encode defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = AType_Encode(&pVal, &pBitStrm, &pErrCode, bCheckConstraints);

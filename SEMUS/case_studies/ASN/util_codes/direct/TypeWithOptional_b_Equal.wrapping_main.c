...
/* Wrapping main template for the function TypeWithOptional_b_Equal defined in the file ../WORKSPACE/DOWNLOADED/casestudy/test.c */
...
int main(int argc, char** argv)
{
    ...
    result_faqas_semu = TypeWithOptional_b_Equal(&pVal1, &pVal2);

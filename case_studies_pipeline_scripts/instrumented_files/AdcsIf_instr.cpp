...
std::ofstream MyFile("/home/svf/logging_change_BEFORE.txt", std::ios_base::app);
...
std::ofstream MyFile("/home/svf/logging_change_AFTER.txt", std::ios_base::app);
        ...
        case 6:
        {
            ...
            case 0:
            {
                ...
                if(cr == CR_Failure){
                  ...
                  //probe SunSensorTMfailure
      		        mutate_FM_SunSensorTMFailure(&newBlock);
                  //end probe
                }
                else{

                  //probe SunSensorTM
      		        mutate_FM_SunSensorTM( &newBlock );
                  //end probe
                }
                //END PROBES
            ...
            case 1:
            {
                ...
                if(cr == CR_Failure){
                  ...
                  //probe SSTPFailure
                  mutate_FM_SSTPFailure( &newBlock );
                  //end probe
                }
                else{
                  //probe SSTP
                  mutate_FM_SSTP( &newBlock );
                  //end probe
                }
                //END PROBES
        ...
        case 9:
        {
            ...
            case 0:
            {
                ...
                if(cr != CR_Failure){
                  ...
                  mutate_FM_SpaceCraftHK( &newBlock);
